...
void protobuf_AssignDesc_Im_2ehelloworld_2eproto() {
  ...
  static const int helloworld_offsets_[4] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(helloworld, pp_),
  };
...
const int helloworld::kPpFieldNumber;
#endif  // !_MSC_VER
...
const helloworld& helloworld::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_Im_2ehelloworld_2eproto();  return *default_instance_;
}
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_pp;
        break;
      }
      ...
      case 4: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_pp:
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_pp()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->pp().data(), this->pp().length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
